...
Reference full template: `C:/st8-workspace/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/st8-workspace/.claude/get-shit-done/templates/state.md`.

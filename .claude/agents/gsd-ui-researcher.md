...
Use template from `C:/st8-workspace/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/st8-workspace/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "C:/st8-workspace/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```

...
<reference>
@C:/st8-workspace/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/st8-workspace/.claude/get-shit-done/references/user-profiling.md` to load:

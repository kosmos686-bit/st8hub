...
```bash
AUDITOR_MODEL=$(node "C:/st8-workspace/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read C:/st8-workspace/.claude/agents/gsd-eval-auditor.md for instructions.

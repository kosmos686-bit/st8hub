...
<execution_context>
@C:/st8-workspace/.claude/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @C:/st8-workspace/.claude/get-shit-done/workflows/code-review-fix.md end-to-end.

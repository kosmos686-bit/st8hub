...
<execution_context>
@C:/st8-workspace/.claude/get-shit-done/workflows/scan.md
</execution_context>

<process>
Execute the scan workflow from @C:/st8-workspace/.claude/get-shit-done/workflows/scan.md end-to-end.
</process>

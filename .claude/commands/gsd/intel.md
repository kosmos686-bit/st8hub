...
Intel system is disabled. To activate:
  ...
  node C:/st8-workspace/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node C:/st8-workspace/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node C:/st8-workspace/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node C:/st8-workspace/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```

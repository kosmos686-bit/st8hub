...
<execution_context>
@C:/st8-workspace/.claude/get-shit-done/workflows/new-workspace.md
@C:/st8-workspace/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @C:/st8-workspace/.claude/get-shit-done/workflows/new-workspace.md end-to-end.

...
<execution_context>
@C:/st8-workspace/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @C:/st8-workspace/.claude/get-shit-done/workflows/manager.md end-to-end.

...
<execution_context>
@C:/st8-workspace/.claude/get-shit-done/workflows/next.md
</execution_context>

<process>
Execute the next workflow from @C:/st8-workspace/.claude/get-shit-done/workflows/next.md end-to-end.
</process>

...
Knowledge graph is disabled. To activate:
  ...
  node C:/st8-workspace/.claude/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node C:/st8-workspace/.claude/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node C:/st8-workspace/.claude/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "C:/st8-workspace/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: C:/st8-workspace/.claude/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"C:/st8-workspace/.claude/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```

...
<execution_context>
@C:/st8-workspace/.claude/get-shit-done/workflows/pr-branch.md
</execution_context>

<process>
Execute the pr-branch workflow from @C:/st8-workspace/.claude/get-shit-done/workflows/pr-branch.md end-to-end.
</process>

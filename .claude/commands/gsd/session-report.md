...
<execution_context>
@C:/st8-workspace/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @C:/st8-workspace/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
